...
const Card = ({ title, subtitle, icon, children, className = "", actions }) => (
  <div
    className={`rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] shadow-sm transition-shadow duration-200 hover:shadow-md overflow-hidden ${className}`}
  >
